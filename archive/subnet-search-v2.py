    ...
    with open(str(filelocation_show_route),'r') as txtlines:
        ...
        ##
            ...
            if line.find('via')!=-1: #look for string with "via" it indicates it has exit interface
                ...
                ### means the subnet originates to other location
                    ...
                    if masterfile_var == 0:
                        ...
                        with open("csv_output/master_file.csv",'w') as master_csv:
                            master_output_csv = str(masterfile_ind)+";"+route_instance+";"+supernet_ip+";"+ipadd+";"+asn_lookup+";"+dest_interface+";"+router_hostname[xx]+"\n"         
                ...
                #y=input()
                #print("%d\t%s\t%s\t%s\t%s\t%s\t%s" %(indx,route_instance,supernet_ip,ipadd,asn_lookup,ipadd,dest_interface))
                #y=input()
                search_output_csv = str(indx)+";"+route_instance+";"+supernet_ip+";"+ipadd+";"+asn_lookup+";"+dest_interface+";"+router_hostname[xx]+"\n"
